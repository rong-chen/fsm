            ...
            <el-carousel-item>
              <div style="width: 100%">
                <el-form-item prop="nickname">
                  <el-input v-model="registerForm.nickname" style="width: 300px;height:40px" placeholder="昵称"/>
                </el-form-item>
                <el-form-item prop="phone">
                  <el-input v-model="registerForm.phone" style="width: 300px;height:40px" placeholder="手机号码"/>
                </el-form-item>
              </div>
            </el-carousel-item>
            <el-carousel-item>
              ...
              >
                ...
                <el-form-item prop="sex">
                  <el-select v-model="registerForm.sex" placeholder="Select" style="width: 300px;height: 40px">
                    <el-option
            ...
            <el-carousel-item>
              <div style="width: 100%">
                <el-form-item prop="email">
                  <el-input v-model="registerForm.email" style="width: 300px;height:40px" placeholder="邮箱"/>
                </el-form-item>
...
<style>
.form-container .el-select__wrapper {
  height: 40px;
}
